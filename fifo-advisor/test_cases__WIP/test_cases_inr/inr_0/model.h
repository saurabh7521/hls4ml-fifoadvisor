...
F_TYPE input_net_0_0_bias_top[256],
    ...
    F_TYPE input_x_top[4096][2],
    F_TYPE output_0_top[4096],
    F_TYPE output_1_top[4096],
    F_TYPE output_2_top[4096],
    F_TYPE output_3_top[4096],
    F_TYPE output_4_top[4096],
    F_TYPE output_5_top[4096],
    F_TYPE output_6_top[4096],
    F_TYPE output_7_top[4096],
    F_TYPE output_8_top[4096]);};
