...
from hls4ml.utils.fifo_advisor import run_fifo_advisor_if_enabled, warn_if_fifo_advisor_runs_after_hls4ml_fifo_opt
...
class VitisBackend(VivadoBackend):
    ...
    def build(
        ...
        warn_if_fifo_advisor_runs_after_hls4ml_fifo_opt(model, fifo_opt=fifo_opt, fifo_advisor=fifo_advisor)
        ...
        report = parse_vivado_report(output_dir)
        return run_fifo_advisor_if_enabled(
            model,
            report,
            fifo_advisor=fifo_advisor,
            fifo_advisor_config=fifo_advisor_config,
        )
